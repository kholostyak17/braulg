			...
			<div className="col-sm-12 col-md-7 right-box">
				...
				<form>
					<div className="form-div">
						...
						<select name="country" className="input-style my-select">
						...
						<input type="text" className="input-style" placeholder="Escribe ciudades" />
						<h2>Fecha estimada de inicio de viaje:</h2>
						<input type="date" className="input-style" name="" id="" />
						<h2>Actividades que vas a realizar:</h2>
						<textarea className="input-style my-textarea" placeholder="Escribe aquí tus planes de viaje" />
						<div className="text-center">
							<input type="submit" value="PROPONER VIAJE" className="button lm secondary mx-auto my-4" />
						</div>
					</div>
				</form>
			</div>
